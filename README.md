...
Para ti, que ya probaste el poder de construir cosas con una IA al lado
(Kitradep, MALP, tu PWA del Mundial) y ahora quieres **entender de verdad**
como funciona todo, para no depender de la magia y poder crear lo que se te
ocurra. No asume que seas ingeniero. Asume que eres curioso y que aprendes
haciendo.

## La promesa

Si sigues esta ruta y construyes los proyectos que propone, en unos meses vas
a poder:
...
- Levantar un frontend, un backend, una base de datos y publicarlos en linea.
- Armar un bot y automatizaciones que trabajen por ti.
...
Despues vuelve a los capitulos como referencia. Cada uno termina con una
seccion **"Hacelo tu"** con ejercicios concretos: no te saltes esa parte, ahi
...
| 05 | [Bots y automatizaciones](05-bots-y-automatizaciones.md) | Que la maquina trabaje por ti: bots, scraping, tareas |
...
```
   [ USUARIO ]
       |
       v
  FRONTEND  ...... lo que se ve y se toca (navegador, celular)  -> cap. 03
       |
  ...
  Y tu construyes todo esto dirigiendo a:
...
No tienes que memorizar nada de esto. Nadie sabe todo de memoria: los mejores
programadores googlean (o le preguntan a la IA) cien veces al dia. Lo que si
tienes que construir es el **mapa mental**: saber que existe cada pieza, para
...
Dale, jefe. Empieza por el capitulo 00. Nos "leemos" en cada pagina.
